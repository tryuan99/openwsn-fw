...
#define LENGTH_PACKET   12+LENGTH_CRC // maximum length is 127 bytes
...
int mote_main(void) {
    ...
    app_vars.txpk_buf[0] = '1';
    app_vars.txpk_buf[1] = '2';
    app_vars.txpk_buf[2] = '3';
    app_vars.txpk_buf[3] = 'A';
    app_vars.txpk_buf[4] = 'B';
    app_vars.txpk_buf[5] = 'C';

...
int mote_main(void) {
    ...
    while (1) {
        ...
        i = 0;
        app_vars.uart_txFrame[i++] = app_vars.rxpk_buf[0];  // packet length
        app_vars.uart_txFrame[i++] = app_vars.rxpk_buf[1];  // packet number
        app_vars.uart_txFrame[i++] = app_vars.rxpk_buf[2];  // RSSI
        app_vars.uart_txFrame[i++] = app_vars.rxpk_buf[3];  // LQI
        app_vars.uart_txFrame[i++] = app_vars.rxpk_buf[4];  // CRC
        app_vars.uart_txFrame[i++] = app_vars.rxpk_buf[5];  // freq_offset
        app_vars.uart_txFrame[i++] = app_vars.rxpk_buf[6];               // closing flag
        app_vars.uart_txFrame[i++] = app_vars.rxpk_buf[7];               // closing flag
        app_vars.uart_txFrame[i++] = app_vars.rxpk_buf[8];
		app_vars.uart_txFrame[i++] = app_vars.rxpk_buf[9];
		app_vars.uart_txFrame[i++] = app_vars.rxpk_buf[10];
		app_vars.uart_txFrame[i++] = app_vars.rxpk_buf[11];
